const LandingHeading = () => (
  <header className="justify-center">
    <h1 className="text-6xl text-gray-900 font-bold inline-block mb-6">
    ...
    {/* <h3 className="text-2xl text-gray-900 font-semibold mb-6 whitespace-pre-line">
        ...
        <h3 className="text-3xl text-blue-500 inline-block">tailored <h3 className="text-gray-900 inline-block">and</h3> delivered</h3>{' '}
        <h3 className="text-2xl text-gray-900 inline-block">straight to you</h3>
      </h3> */}
  </header>
);
